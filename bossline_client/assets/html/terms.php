...
<html class="no-js" lang="ko">
  <head>
    ...
    <meta property="og:url" content="https://bossline.gg/terms.php">
    <!-- 트위터 OG태그 -->
    <meta name="twitter:card" content="summary">  
    <meta name="twitter:url" content="https://bossline.gg/terms.php">
  ...
  <body>
    <div class="wrapper">
      <header class="header">
        ...
        >
          <h1 class="cover-title">서비스이용약관</h1>
        </div>
...
제1조 목적<br>
<br>
본 이용약관은 “bossline.gg”(이하 "사이트")의 서비스의 이용조건과 운영에 관한 제반 사항 규정을 목적으로 합니다.<br>
<br>
제2조 용어의 정의<br>
<br>
