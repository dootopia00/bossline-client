...
<html class="no-js" lang="ko">
  ...
  <body>
    ...
    <div id="extend" class="modal" style="visibility:visible;" data-type="basic" data-value="lin2m">
      <div class="dialog" role="dialog">
        <h1 class="dialog-title">보탐스마트 서비스 연장</h1>
        <h4 class="dialog-data">가격 : <span id="price">30000</span></h4>
        
        </p>
        <h2 class="dialog-data">이름 : 
          <input type = "text"
                 id = "name"
                 value = "" />
        </h2>
        <h2 class="dialog-data">이메일 : 
          <input type = "text"
                 id = "email"
                 value = "" />
        </h2>
        <h2 class="dialog-data">전화번호 : 
          <input type = "text"
                 id = "tel"
                 value = "" />
        </h2>
