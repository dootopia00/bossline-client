...
<html class="no-js" lang="ko">
  <head>
    ...
    <meta property="og:url" content="https://bossline.gg/lineage-2m-03.php">
    <!-- 트위터 OG태그 -->
    <meta name="twitter:card" content="summary">  
    <meta name="twitter:url" content="https://bossline.gg/lineage-2m-03.php">
    ...
    <div class="wrapper">
      <header class="header">
        ...
        <div class="menu">
          <ul class="menu-list">
            ...
            <li class="menu-item">
              <a href="/lineage-m-01.php" class="menu-link">
                <span>리니지M</span>
              </a>
            </li>
            <li class="menu-item is-active">
              <a href="/lineage-2m-01.php" class="menu-link">
                <span>리니지2M</span>
              </a>
            </li>
            <li class="menu-item">
              <a href="/v4-01.php" class="menu-link">
                <span>V4</span>
              </a>
            </li>
            <li class="menu-item">
              <a href="/etc_games.php" class="menu-link">
                <span>그 외 게임</span>
              </a>
            </li>
          </ul>
        ...
        <div
          class="cover"
          style="background-image: url(./assets/img/bg_cover02.jpg)"
        >
          <h1 class="cover-title">리니지2M</h1>
          <span class="cover-breadcrumb">
            <a href="/">홈</a>
            <a href="/lineage-2m-01.php">리니지2M</a>
            <a href="/lineage-2m-03.php">포인트봇</a>
          </span>
        </div>
      ...
      <main class="container">
        <div class="tab" role="navigation">
          <div class="tab-row">
            <a href="/lineage-2m-01.php" class="tab-link">기본봇</a>
            <a href="/lineage-2m-02.php" class="tab-link">분배봇</a>
            <a href="/lineage-2m-03.php" class="tab-link is-active">포인트봇</a>
          </div>
        </div>
        <div class="content">
          <header class="title-group">
            <div class="title-group-col col-auto">
              ...
              <p>
                리니지2M
                전용봇에 보스참여자별 점수 획득기능이 추가된 프리미엄 봇입니다.
              </p>
            </div>
            <div class="title-group-col">
              <img src="./assets/img/badge_premium.png" alt="프리미엄" />
          ...
          <div class="headline">
            <div class="headline-col">
              ...
              <div
                ...
                style="background-image: url('https://img.youtube.com/vi/-SbXudcPwxk/0.jpg')"
                data-youtube-id="-SbXudcPwxk"
              >
            ...
            <div class="headline-col">
              <div class="headline-content">
                <h3 class="headline-title">포인트봇 동영상 설명서</h3>
          ...
          <div class="section">
            <h3 class="section-title">프리미엄 기능</h3>
