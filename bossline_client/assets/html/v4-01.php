...
<html class="no-js" lang="ko">
  <head>
    ...
    <meta property="og:url" content="https://bossline.gg/v4-01.php">
    <!-- 트위터 OG태그 -->
    <meta name="twitter:card" content="summary">  
    <meta name="twitter:url" content="https://bossline.gg/v4-01.php">
  ...
  <body>
    <div class="wrapper">
      <header class="header">
        ...
        <div
          class="cover"
          style="background-image: url(./assets/img/bg_cover01.jpg)"
        >
          <h1 class="cover-title">V4</h1>
          <span class="cover-breadcrumb">
            <a href="/">홈</a>
            <a href="/v4-01.php">V4</a>
            <a href="/v4-01.php">기본봇</a>
          </span>
        </div>
      ...
      <main class="container">
        <div class="tab" role="navigation">
          <div class="tab-row">
            <a href="/v4-01.php" class="tab-link is-active">기본봇</a>
          </div>
        </div>
        <div class="content">
          ...
          <div class="headline">
            <div class="headline-col">
              ...
              <div
                ...
                style="background-image: url('https://img.youtube.com/vi/1a3brtsVK04/0.jpg')"
                data-youtube-id="1a3brtsVK04"
              >
