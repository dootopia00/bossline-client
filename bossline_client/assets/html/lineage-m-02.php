...
<html class="no-js" lang="ko">
  <head>
    ...
    <meta property="og:url" content="https://bossline.gg/lineage-m-02.php">
    <!-- 트위터 OG태그 -->
    <meta name="twitter:card" content="summary">  
    <meta name="twitter:url" content="https://bossline.gg/lineage-m-02.php">
  ...
  <body>
    <div class="wrapper">
      <header class="header">
        ...
        <div
          class="cover"
          style="background-image: url(./assets/img/bg_cover03.jpg)"
        >
          <h1 class="cover-title">리니지M</h1>
          <span class="cover-breadcrumb">
            <a href="/">홈</a>
            <a href="/lineage-m-01.php">리니지M</a>
            <a href="/lineage-m-02.php">분배봇</a>
          </span>
        </div>
      ...
      <main class="container">
        <div class="tab" role="navigation">
          <div class="tab-row">
            <a href="/lineage-m-01.php" class="tab-link">기본봇</a>
            <a href="/lineage-m-02.php" class="tab-link is-active">분배봇</a>
            <a href="/lineage-m-03.php" class="tab-link">포인트봇</a>
          </div>
        </div>
        <div class="content">
          <header class="title-group">
            <div class="title-group-col col-auto">
              ...
              <p>
                리니지M 전용봇에 아이템 관리 및 참여인원 관리가 추가된 프리미엄
                봇입니다.
              </p>
            </div>
          </header>
