...
<html class="no-js" lang="ko">
  <head>
    ...
    <meta property="og:url" content="https://bossline.gg/lineage-2m-01.php">
    <!-- 트위터 OG태그 -->
    <meta name="twitter:card" content="summary">  
    <meta name="twitter:url" content="https://bossline.gg/lineage-2m-01.php">
    ...
    <div class="wrapper">
      <header class="header">
        ...
        >
          ...
          <span class="cover-breadcrumb">
            ...
            <a href="/lineage-2m-01.php">기본봇</a>
          </span>
        </div>
      ...
      <main class="container">
        <div class="tab" role="navigation">
          <div class="tab-row">
            <a href="/lineage-2m-01.php" class="tab-link is-active">기본봇</a>
            <a href="/lineage-2m-02.php" class="tab-link">분배봇</a>
            <a href="/lineage-2m-03.php" class="tab-link">포인트봇</a>
          </div>
        </div>
        <div class="content">
          ...
          <div class="headline">
            <div class="headline-col">
              <!--MEMO: data-
                ube-id 속성에 유튜브 아이디값만 넣으시면 돼요.-->
              <div
                class="headline-video"
                style="background-image: url('https://img.youtube.com/vi/xjfA85an3to/0.jpg')"
                data-youtube-id="xjfA85an3to"
              >
